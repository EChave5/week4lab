...
var availableSeatsOnFlight = 10;
console.log("the number of available seats left are" + availableSeatsOnFlight)


console.log("Step 2:  Cost of Groceries");
var costOfGroceries = 100.54;
console.log("The groceries cost $" + costOfGroceries);
...
//  ↓ YOUR CODE HERE ↓
var bookedSeats = 2;
console.log("Two seats were booked, there are now " + (availableSeatsOnFlight - bookedSeats) + " seats left");

    console.log('Buy a Candy Bar:')
//	Impulse candy bar purchase! Add 2.15 to the grocery total
//  ↓ YOUR CODE HERE ↓
console.log("After buying the candy bar, the groceries now cost $" + (costOfGroceries + 2.15) );

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = "D";
console.log ("The middle initial has been fixed, it now reads " + middleInitial + " on the birth certificate");

    console.log('Changing Seasons:')
//	The season has changed, update the hot outside variable	to be opposite of what it was
//  ↓ YOUR CODE HERE ↓
    itIsHotOutside = false; 
    console.log ("The weather has changed, is it still hot outside?  " + itIsHotOutside);
...
//  ↓ YOUR CODE HERE ↓
var fullName = customerFirstName + " " + middleInitial + " " +  "Douglas";
...
console.log ("Let me introduce you to " + fullName + ", they live at " + streetAddress);
